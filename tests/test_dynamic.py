...
MIN_INDICATORS = [
    dict(
        code="BASIC_003", name="注册成立年限", level="基本项", category_code="BASIC",
        category_name="通用", indicator_type="数值", unit="年", value_range="≥0，截至评估时点",
        data_source="营业执照", is_feature=False, risk_meaning="主体存续时间",
        weight_star=4.5, region="东北全境", is_veto=False, cycle="实时",
        scoring_rule="数值：越高越好，参考上限 30 年", display_order=3,
    ),
    dict(
        code="BASIC_008", name="年营业收入", level="基本项", category_code="BASIC",
        category_name="通用", indicator_type="数值", unit="万元", value_range="近 12 个月主营业务收入",
        data_source="财务报表", is_feature=False, risk_meaning="经营规模",
        weight_star=5.0, region="东北全境", is_veto=False, cycle="年报",
        scoring_rule="数值：越高越好，参考上限 500 万元", display_order=8,
    ),
    dict(
        code="BASIC_013", name="当前被列为失信被执行人", level="基本项", category_code="BASIC",
        category_name="通用", indicator_type="布尔", unit="", value_range="是/否",
        data_source="法院执行信息", is_feature=False, risk_meaning="重大信用风险",
        weight_star=5.0, region="东北全境", is_veto=True, cycle="实时",
        scoring_rule="命中即拒贷", display_order=13,
    ),
    dict(
        code="01_05", name="土地/水域经营总面积", level="大类", category_code="01",
        category_name="农林牧渔业", indicator_type="数值", unit="亩", value_range="≥0",
        data_source="流转合同/村委", is_feature=False, risk_meaning="经营规模基础",
        weight_star=4.0, region="东北全境", is_veto=False, cycle="年报",
        scoring_rule="数值：越高越好，参考上限 3000 亩", display_order=5,
    ),
]
